...
import { motion, LayoutGroup } from "framer-motion"; // Importamos las herramientas de animación
import {
  Home,
  Settings,
  Dog,
...
const Sidebar = () => {
  ...
  const menuItems = [
    { icon: <Home />, label: "Dashboard", href: "/assistant/home" },
    { icon: <Dog />, label: "Medical history", href: "/assistant/historial" },
    { icon: <Package />, label: "Stock", href: "/assistant/stock" },
    { icon: <User />, label: "Reportes", href: "/assistant/reportes" },
  ];
